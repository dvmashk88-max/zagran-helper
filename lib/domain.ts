...
export type Activity = { id: string; kind: "work" | "study" | "service" | "unemployed"; from: string; to: string; current: boolean; organization: string; position: string; address: string };
export type Draft = {
  consent: boolean; passportKind: PassportKind | ""; lastName: string; firstName: string; middleName: string; noMiddleName: boolean;
...
export const EMPTY_DRAFT: Draft = {
  consent:false,passportKind:"",lastName:"",firstName:"",middleName:"",noMiddleName:false,gender:"",birthDate:"",birthPlace:"",changedName:"",previousName:"",changeDate:"",changePlace:"",
  ...
  hasForeignPassport:"",foreignSeries:"",foreignNumber:"",foreignIssueDate:"",foreignIssuer:"",foreignLost:false,foreignForCancellation:false,restriction:"",restrictionDetails:"",secretAccess:"",secretDetails:"",contractualRestriction:"",contractDetails:"",activities:[],
};
